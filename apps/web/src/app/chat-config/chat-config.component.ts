        ...
        <div class="config-section">
          <label class="config-label">
            ...
            <select [(ngModel)]="agentType" class="config-select">
              ...
              <option value="crewai-expert">CrewAI Expert</option>
            </select>
          </label>
          <p class="config-hint">Specialist mode uses multiple specialized agents, Single Agent uses one general agent, CrewAI runs CrewAI projects from source, CrewAI Expert runs CrewAI projects with dependency patching and approvals</p>
        </div>
